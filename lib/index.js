...
var extractRawText = function (documentURL, ocrLibrary, customOCR, languages) { return __awaiter(void 0, void 0, void 0, function () {
    var apiKey;
...
SmartDocuments.extractDocumentDetailsFromImage = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var documentType, documentURL, ocrLibrary, customParser, customOCR, languages, languageList, ocrResponse, rawText, isValidText, documentDetails;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                documentType = params.document_type, documentURL = params.document_url, ocrLibrary = params.ocr_library, customParser = params.custom_parser, customOCR = params.custom_ocr, languages = params.languages;
                languageList = languages;
                if (lodash_1.default.isEmpty(languages)) {
                    languageList = constants_1.default.DEFAULT_LANUGUAGES;
                }
                return [4 /*yield*/, extractRawText(documentURL, ocrLibrary, customOCR, languageList)];
            case 1:
                ocrResponse = _a.sent();
